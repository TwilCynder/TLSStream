...
- On sort les casque micro, qui se trouvent dans des housses noires
  ...
  - Si les casters sont un tant soit peu loin de la régie, il va falloir utiliser les rallonges : 2 rallonges XLR pour les prises XLR des casques (elles sont souvent dans le même sac que le clavier/souris, c'est celles avec les embouts bleus), 1 rallonge jack pour le gros jack des casters (entre le splitter et la table/carte du coup, pour ça qu'il y a besoin que d'une seule)
